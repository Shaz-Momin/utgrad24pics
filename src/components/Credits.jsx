...
const Credits = () => {
  return (
    <div className="h-1/2 border border-t-2 p-16 flex flex-col items-center">
        ...
        <div className="text-lg font-extralight max-w-[36rem] p-4 mb-12 text-slate-700 italic">for capturing my senior pictures at UT Austin. It was such a special time in my life, and his expertise helped me commemorate it perfectly. Aarish made the whole experience so much fun and relaxed, and I absolutely love the way the photos turned out! Thank you again for everything!</div>
